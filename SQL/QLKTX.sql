USE [master]
GO
/****** Object:  Database [ql_KTX]    Script Date: 6/18/2022 10:58:25 AM ******/
...
USE [ql_KTX]
GO
/****** Object:  Table [dbo].[HOADONDIEN]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[HOPDONG]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LOAIPHONG]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PERMISSION]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PHANCONGVIEC]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PHANQUYEN]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PHONG]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[QUANLY]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[QUYENTAIKHOAN]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SINHVIEN]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TAIKHOAN]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VATTU]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[VT_PHONG]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[HOPDONG] ([MAHD], [NGAYTAO], [SOTIEN], [NAMHOC], [HOCKY], [TIENNO], [MAPHONG], [MASV], [MAQL]) VALUES (N'HD00000007', CAST(N'2020-02-18' AS Date), 1650000.0000, N'2019-2020', N'2', 0.0000, N'B05', N'N19DCAT002', N'QL00000002')
GO
...
GO
INSERT [dbo].[HOPDONG] ([MAHD], [NGAYTAO], [SOTIEN], [NAMHOC], [HOCKY], [TIENNO], [MAPHONG], [MASV], [MAQL]) VALUES (N'HD00000013', CAST(N'2022-06-08' AS Date), 860000.0000, N'2021-2022', N'3', 0.0000, N'C02', N'2344      ', N'QL00000007')
GO
INSERT [dbo].[HOPDONG] ([MAHD], [NGAYTAO], [SOTIEN], [NAMHOC], [HOCKY], [TIENNO], [MAPHONG], [MASV], [MAQL]) VALUES (N'HD00000014', CAST(N'2022-06-06' AS Date), 860000.0000, N'2021-2022', N'3', 0.0000, N'C02', N'N19DCAT013', N'QL00000010')
GO
...
GO
INSERT [dbo].[PHANCONGVIEC] ([MAPQ], [MAPMS]) VALUES (N'qlp2', N'HD        ')
GO
INSERT [dbo].[PHANCONGVIEC] ([MAPQ], [MAPMS]) VALUES (N'qlp2', N'P         ')
GO
...
GO
INSERT [dbo].[PHANQUYEN] ([MAPQ], [VAITRO]) VALUES (N'qlp2', N'quan ly phong 2')
GO
...
GO
INSERT [dbo].[PHONG] ([MAPHONG], [TINHTRANG], [SUCCHUA], [KHU], [MALOAIPHONG], [MAQL]) VALUES (N'C02', N'OK', 2, N'C', N'DVVIP', N'QL00000003')
GO
...
GO
INSERT [dbo].[QUYENTAIKHOAN] ([USERNAME], [MAPQ], [NGAYSET]) VALUES (N'admin', N'AD  ', CAST(N'2022-06-18' AS Date))
GO
INSERT [dbo].[QUYENTAIKHOAN] ([USERNAME], [MAPQ], [NGAYSET]) VALUES (N'admin2', N'AD', CAST(N'2022-01-01' AS Date))
GO
INSERT [dbo].[QUYENTAIKHOAN] ([USERNAME], [MAPQ], [NGAYSET]) VALUES (N'test', N'qlp2', CAST(N'2022-06-18' AS Date))
GO
...
GO
INSERT [dbo].[QUYENTAIKHOAN] ([USERNAME], [MAPQ], [NGAYSET]) VALUES (N'userp1', N'QLHD', CAST(N'2022-06-18' AS Date))
GO
INSERT [dbo].[QUYENTAIKHOAN] ([USERNAME], [MAPQ], [NGAYSET]) VALUES (N'userp1', N'QLP ', CAST(N'2022-06-18' AS Date))
GO
...
GO
INSERT [dbo].[TAIKHOAN] ([USERNAME], [PASSWORD], [TINHTRANGSUDUNG]) VALUES (N'test', N'test', 1)
GO
...
GO
INSERT [dbo].[VT_PHONG] ([MAPHONG], [MAVT], [NGAYTHEM], [SOLUONG], [TINHTRANG], [TIENNO]) VALUES (N'A01', N'BA01', CAST(N'2022-06-15' AS Date), 1, N'OK', 0)
GO
INSERT [dbo].[VT_PHONG] ([MAPHONG], [MAVT], [NGAYTHEM], [SOLUONG], [TINHTRANG], [TIENNO]) VALUES (N'A04', N'KG01', CAST(N'2022-04-04' AS Date), 1, N'Tốt', 1)
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UK_CONGVIEC]    Script Date: 6/18/2022 10:58:25 AM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UK_USERNAME]    Script Date: 6/18/2022 10:58:25 AM ******/
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DOLOGIN]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_GETPHANQUYENPERMISSION]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROC [dbo].[SP_GETPHANQUYENPERMISSION]
@MAPQ NCHAR (50)
AS
BEGIN
    SELECT PHANCONGVIEC.*, PERMISSION.CONGVIEC
	FROM PHANCONGVIEC
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_GETTHONGTINPHONGCONCHOTRONG]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROC [dbo].[SP_GETTHONGTINPHONGCONCHOTRONG]
@NAMHOC CHAR (9), @HOCKY CHAR(1)
AS
BEGIN
    SELECT PHONG.*, LOAIPHONG.DICHVU, (PHONG.SUCCHUA - ISNULL(HD.SLHD, 0)) AS CONTRONG
	FROM PHONG 
	INNER JOIN LOAIPHONG
		ON PHONG.MALOAIPHONG = LOAIPHONG.MALOAIPHONG
	LEFT JOIN 
		(
			SELECT HOPDONG.MAPHONG, COUNT(*) AS SLHD
			FROM HOPDONG
			WHERE HOPDONG.NAMHOC = @NAMHOC AND HOPDONG.HOCKY = @HOCKY
			GROUP BY HOPDONG.MAPHONG
		) HD
		ON HD.MAPHONG = PHONG.MAPHONG
	--WHERE (PHONG.SUCCHUA - ISNULL(HD.SLHD, 0)) > 0
END
GO
/****** Object:  StoredProcedure [dbo].[SP_GETUSERINFO]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_GETUSERPERMISSION]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
BEGIN
    SELECT QUYENTAIKHOAN.*, PHANQUYEN.VAITRO, PERMISSION.MAPMS, PERMISSION.CONGVIEC
	FROM QUYENTAIKHOAN
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_GETUSERPHANQUYEN]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROC [dbo].[SP_GETUSERPHANQUYEN]
@USERNAME NCHAR (50)
AS
BEGIN
    SELECT QUYENTAIKHOAN.*, PHANQUYEN.VAITRO
	FROM QUYENTAIKHOAN
	INNER JOIN PHANQUYEN
		ON QUYENTAIKHOAN.MAPQ = PHANQUYEN.MAPQ
	WHERE USERNAME = @USERNAME
END
GO
/****** Object:  StoredProcedure [dbo].[SP_SINHVIENTHEOPHONG]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_VERIFYADMINAUTHORIZATION]    Script Date: 6/18/2022 10:58:25 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    IF (EXISTS (SELECT TAIKHOAN.USERNAME 
				...
				WHERE TAIKHOAN.USERNAME = @ADMINUSERNAME AND PASSWORD = @ADMINPASSWORD))
		SELECT 1;
	ELSE 
		SELECT 0;
END
